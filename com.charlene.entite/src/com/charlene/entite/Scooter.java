...
class Scooter extends VehiculeAMoteur {
    ...
    public Scooter(String marque, String modele, Moteur moteur) {
        super(marque, modele, moteur);
       
    }

    public Scooter(String marque, String modele, float carburant){super(marque, modele); this.carburant = carburant;}
